...
const DEFAULTS = {
  vi: {
    ...
    'create.fieldsList': 'Trường thông tin danh sách',
    'create.fieldsOpen': 'Thông tin ghi danh cần nhập',
    'create.fieldsHint': '(chọn trường dùng, đánh dấu bắt buộc, thêm trường riêng)',
    ...
    'admin.i18n.filterPh': 'Lọc theo khoá hoặc nội dung…',
    'admin.sys.smtpDesc': 'Dùng để gửi email đặt lại mật khẩu và thông báo kết thúc phiên. VD Gmail: smtp.gmail.com, cổng 587, mật khẩu là App Password.',
    'admin.smtp.host': 'Máy chủ SMTP',
    'admin.smtp.port': 'Cổng',
    'admin.smtp.user': 'Tài khoản',
    'admin.smtp.pass': 'Mật khẩu',
    'admin.smtp.passKeep': '(bỏ trống = giữ nguyên)',
    'admin.smtp.passSaved': '(đã lưu — bỏ trống để giữ nguyên)',
    'admin.smtp.from': 'Địa chỉ người gửi (From — bỏ trống dùng tài khoản)',
    'admin.fields.desc': 'Chọn trường nào có trong mẫu (người dùng tải template về sẽ thấy) và trường nào bắt buộc nhập khi chuẩn bị danh sách. Có thể thêm trường riêng với tên tiếng Việt và tiếng Anh. Cần bật ít nhất một trong hai trường định danh (Số CCCD / Số điện thoại).',
    'admin.fields.nameVi': 'Tên (Tiếng Việt)',
    'admin.fields.nameEn': 'Tên (English)',
    'admin.fields.custom': '(trường riêng)',
    'admin.fields.addViPh': 'Tên trường (Tiếng Việt) — VD: Chức vụ',
    'admin.fields.addEnPh': 'Name (English) — e.g. Position',
    'admin.users.note': 'Người dùng mới sẽ được yêu cầu đổi mật khẩu khi đăng nhập lần đầu. Email dùng để đặt lại mật khẩu và nhận thông báo hệ thống.',
    'admin.users.initPassPh': '',
    'admin.users.colUsername': 'Tên đăng nhập',
    'admin.users.resetPw': 'Đặt lại mật khẩu',
    'admin.users.editTitle': 'Sửa người dùng',
    'admin.users.editSave': 'Lưu thay đổi',
    'admin.users.testEmailPh': 'Email nhận thử',
  ...
  en: {
    ...
    'create.fieldsList': 'Attendance list fields',
    'create.fieldsOpen': 'Registration fields to fill',
    'create.fieldsHint': '(pick fields, mark required, add custom fields)',
    ...
    'admin.i18n.filterPh': 'Filter by key or content…',
    'admin.sys.smtpDesc': 'Used to send password-reset emails and session-close notifications. e.g. Gmail: smtp.gmail.com, port 587, password is an App Password.',
    'admin.smtp.host': 'SMTP host',
    'admin.smtp.port': 'Port',
    'admin.smtp.user': 'Account',
    'admin.smtp.pass': 'Password',
    'admin.smtp.passKeep': '(leave empty to keep)',
    'admin.smtp.passSaved': '(saved — leave empty to keep)',
    'admin.smtp.from': 'Sender address (From — empty uses account)',
    'admin.fields.desc': 'Choose which fields are in the template (users downloading it will see them) and which are required when preparing the list. You can add custom fields with Vietnamese and English names. At least one identifier field (ID number / Phone) must be enabled.',
    'admin.fields.nameVi': 'Name (Vietnamese)',
    'admin.fields.nameEn': 'Name (English)',
    'admin.fields.custom': '(custom field)',
    'admin.fields.addViPh': 'Field name (Vietnamese) — e.g. Chức vụ',
    'admin.fields.addEnPh': 'Name (English) — e.g. Position',
    'admin.users.note': 'New users will be asked to change their password on first login. Email is used for password reset and system notifications.',
    'admin.users.initPassPh': '',
    'admin.users.colUsername': 'Username',
    'admin.users.resetPw': 'Reset password',
    'admin.users.editTitle': 'Edit user',
    'admin.users.editSave': 'Save changes',
    'admin.users.testEmailPh': 'Test recipient email',
